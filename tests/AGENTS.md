...
`tests/` mixes backend unit tests and opt-in end-to-end checks.
...
- Keep test behavior aligned with CI, which runs lint/type checks before the full pytest suite.
