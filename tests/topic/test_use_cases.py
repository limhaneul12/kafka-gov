...
class TestTopicBatchApplyUseCase:
    ...
    @pytest.mark.asyncio
    async def test_apply_create_topics(
        self,
        mock_topic_repository,
        mock_metadata_repository,
        mock_audit_repository,
    ...
    @pytest.mark.asyncio
    async def test_apply_delete_topics(
        self,
        mock_topic_repository,
        mock_metadata_repository,
        mock_audit_repository,
    ...
    @pytest.mark.asyncio
    async def test_apply_with_failures(
        self,
        mock_topic_repository,
        mock_metadata_repository,
        mock_audit_repository,
    ...
    @pytest.mark.asyncio
    async def test_apply_blocked_by_policy_violations(
        self,
        mock_topic_repository,
        mock_metadata_repository,
        mock_audit_repository,
    ...
    @pytest.mark.asyncio
    async def test_apply_update_partitions(
        self,
        mock_topic_repository,
        mock_metadata_repository,
        mock_audit_repository,
