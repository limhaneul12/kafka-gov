...
@endpoint_error_handler(
    ...
    default_message="Failed to retrieve correlations",
)
...
@inject
@endpoint_error_handler(default_message="Failed to retrieve topic schemas")
...
@inject
@endpoint_error_handler(default_message="Failed to retrieve schema topics")
...
@endpoint_error_handler(
    ...
    default_message="Failed to analyze schema impact",
)
...
@inject
@endpoint_error_handler(default_message="Failed to retrieve topic count")
async def get_topic_count(service=CorrelationServiceDep) -> dict[str, int]:
    """토픽 개수 조회"""
...
@inject
@endpoint_error_handler(default_message="Failed to retrieve schema count")
async def get_schema_count(service=CorrelationServiceDep) -> dict[str, int]:
    """스키마 개수 조회"""
...
@inject
@endpoint_error_handler(default_message="Failed to retrieve statistics")
async def get_statistics(service=CorrelationServiceDep) -> StatisticsResponse:
    """전체 통계 조회"""
