...
from app.topic.domain.repositories.metrics_interfaces import IStorageMetricsRepository
from app.topic.infrastructure.adapter.kafka_metric_adapter import BaseMetricsCollector


class StorageMetricsCollector(BaseMetricsCollector, IStorageMetricsRepository):
    """저장용량 관련 메트릭 수집기"""
