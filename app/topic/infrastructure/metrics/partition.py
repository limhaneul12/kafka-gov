...
from app.topic.domain.repositories.metrics_interfaces import IPartitionMetricsRepository
from app.topic.infrastructure.adapter.kafka_metric_adapter import BaseMetricsCollector


class PartitionMetricsCollector(BaseMetricsCollector, IPartitionMetricsRepository):
    """파티션 수 관련 메트릭 수집기"""
